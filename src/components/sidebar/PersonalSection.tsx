import { ShoppingBag, Shirt, Camera, Briefcase, Heart, Pencil, Share2, PlusCircle, ScanLine, Upload, FileText, Shirt as ShirtIcon } from "lucide-react";
...
export const PersonalSection = () => {
  ...
  return <AccordionItem value="personal" className="border-none">
